...
func (r *DefaultRequest) GetFile() *File {
	return r.file
}
...
func (r *DefaultRequest) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: %w", ErrFailedToMarshalRequestToJSON, err)
	}
...
func (r *DefaultRequest) SetData(jsonData json.RawMessage) error {
	if r.file != nil {
		return ErrCantUseBothDataAndFile
	}
...
func (r *DefaultRequest) SetFile(file *File) error {
	if r.data != nil {
		return ErrCantUseBothDataAndFile
	}
...
func (r *DefaultRequest) UnmarshalJSON(rawData []byte) error {
	...
	if err != nil {
		return ErrFailedToUnmarshalJSONtoRequest
	}
